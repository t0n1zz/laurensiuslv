        ...
        <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner" >
            <div class="container">
                <div class="navbar-header" >
                    ...
                    <a class="navbar-brand shadow" href="{{ route('home') }}"><img src="{{ asset('images/logo2.png') }}"  alt="logo"></a>
                </div>
                <div class="collapse navbar-collapse" >
                    <ul class="nav navbar-nav navbar-right">
                        <li class="shadow"><a href="{{ route('home') }}">Blog</a></li>
                        <li class="shadow"><a href="{{ route('jetassault') }}">JetAssault</a></li>
                        <li class="shadow"><a href="{{ route('jetassaultgatekeeper') }}">JetAssault:Gatekeeper</a></li>
                        <li class="shadow"><a href="{{ route('myworld') }}">MYWorld</a></li>
                        <li class="shadow"><a href="{{ route('about') }}">About Me</a></li>
                    </ul>
                </div>
            </div>
        </header>
